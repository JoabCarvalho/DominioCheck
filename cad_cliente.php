...
<form method="post">
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="dominio" name="link" placeholder="Domínio" value="<?php if (isset($_GET['edit'])) echo $getROW['link']; ?>" >
    </div>
    <div class="clearfix"></div>
    <div class="form-group col-md-4">
        <label for="Cliente">Cliente</label>
        <input type="text" class="form-control" id="cliente" name="cliente" placeholder="Cliente" value="<?php if (isset($_GET['edit'])) echo $getROW['cliente']; ?>">
    </div>
    <div class="clearfix"></div>
    <div class="form-group col-md-4">
    <?php
