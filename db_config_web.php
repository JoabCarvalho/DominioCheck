...
define('_HOST_NAME', 'mysql.hostinger.com.br'); // Endereço do servidor MySql
define('_DATABASE_NAME', 'u725318385_dsc'); // Nome do banco de dados
define('_DATABASE_USER_NAME', 'u725318385_dsc'); // Nome do usuário
define('_DATABASE_PASSWORD', 'reigomes@250781'); // Senha do usuário
